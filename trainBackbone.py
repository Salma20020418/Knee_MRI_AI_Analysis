...
from dataloader import train_dataloader, valid_dataloader,device, class_names
...
if __name__ == '__main__':
    ...
    metrics = evaluate_on_test_set(modelBackbone, valid_dataloader, loss_fn,threshold=0.5)
